...
namespace DataAccess.Concrete.InMemory
{
    public class InMemoryProductDal : IProductDal
    {
        ...
        {
            // Product productToDelete=new Product();    aşırı hatalı kod
            ...
            Product productToDelete = _products.SingleOrDefault(p=>p.ProductId == product.ProductId); //yukarıdaki foreachin işini yapıyor
